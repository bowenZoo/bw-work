...
.vis-pill { padding: 6px 16px; border-radius: 100px; border: 1.5px solid #D1D5DB; background: #FFFFFF; font-size: 13px; cursor: pointer; transition: border-color 0.15s, background 0.15s; }
