...
- 运营策划：负责运营可行性、MVP 判断、付费健康度、留存设计、上线节奏
...
**提醒**：你的团队只有系统策划、数值策划、玩家代言人、运营策划四个角色。
...
### 【需要深入】
- 对于需要进一步讨论的点，提出具体问题
- 只能指定以下角色回答：系统策划 / 数值策划 / 玩家代言人 / 运营策划
- 格式：[问题]? → @角色
...
**提醒**：参与本次讨论的角色只有：系统策划、数值策划、玩家代言人、运营策划。
...
## 6. 下一步行动
- [ ] 列出具体的执行任务
- [ ] 指定责任人（只能是：主策划/系统策划/数值策划/玩家代言人/运营策划）
- [ ] 标明优先级（P0/P1/P2）
...
指定谁来回答（只能指定：系统策划、数值策划、玩家代言人、运营策划）。
